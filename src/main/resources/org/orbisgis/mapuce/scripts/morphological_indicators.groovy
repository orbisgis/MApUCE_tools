...
def processing() {
    ...
    **/
    ...
    logger.warn i18n.tr("Cleaning the database")
    ...
    **/
    ...
    sql.execute "COMMENT ON COLUMN USR_INDICATORS.dcomiris IS 'Unique identifier of the IRIS';"
    
    
    literalOutput = i18n.tr("All morphological indicators have calculated and stored in 3 tables USR_INDICATORS, BLOCK_INDICATORS and BUILDING_INDICATORS.")
