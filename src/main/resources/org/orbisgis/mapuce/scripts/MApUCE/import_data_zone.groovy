...
def query = "CREATE LINKED TABLE USR_TEMP ('org.orbisgis.postgis_jts.Driver', 'jdbc:postgresql_h2://ns380291.ip-94-23-250.eu:5432/mapuce'," 
	...
	sql.execute query
	sql.execute "CREATE TABLE USR_MAPUCE(PK serial NOT NULL PRIMARY KEY, THE_GEOM geometry, IDZONE integer NOT NULL, VEGETATION_SURFACE double, ROUTE_SURFACE double, HYDRO_SURFACE double, USR_AREA double) AS SELECT PK, THE_GEOM, IDZONE, VEGETATION_SURFACE, ROUTE_SURFACE,  HYDRO_SURFACE, ST_AREA(THE_GEOM) as USR_AREA FROM USR_TEMP"
